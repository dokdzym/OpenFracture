//using System.Collections.Generic; //brandotodo 
//using UnityEngine;
...
////        NativeArray<MeshVertex> islandVertices = new NativeArray<MeshVertex>(vertices.Length, Allocator.Temp, NativeArrayOptions.UninitializedMemory);//brando
//        List<MeshVertex> islandVertices = new List<MeshVertex>(vertices.Length);//brando
//
...
//                
//                island.SetVertices(new List<Vector3>(totalIndexCount));
//                island.SetNormals(islandVertices[i].uv);
//
